...
GSL_EXPORT gsl_vector_ushort *gsl_vector_ushort_alloc_from_block (gsl_block_ushort * b,
                                                                const size_t offset,
                                                                const size_t n,
                                                                const size_t stride);

GSL_EXPORT gsl_vector_ushort *gsl_vector_ushort_alloc_from_vector (gsl_vector_ushort * v,
                                                                 const size_t offset,
                                                                 const size_t n,
                                                                 const size_t stride);
...
GSL_EXPORT unsigned short gsl_vector_ushort_get (const gsl_vector_ushort * v, const size_t i);
GSL_EXPORT void gsl_vector_ushort_set (gsl_vector_ushort * v, const size_t i, unsigned short x);

GSL_EXPORT unsigned short *gsl_vector_ushort_ptr (gsl_vector_ushort * v, const size_t i);
GSL_EXPORT const unsigned short *gsl_vector_ushort_const_ptr (const gsl_vector_ushort * v, const size_t i);

GSL_EXPORT void gsl_vector_ushort_set_zero (gsl_vector_ushort * v);
GSL_EXPORT void gsl_vector_ushort_set_all (gsl_vector_ushort * v, unsigned short x);
...
GSL_EXPORT int gsl_vector_ushort_fprintf (FILE * stream, const gsl_vector_ushort * v,
                                         const char *format);
...
GSL_EXPORT unsigned short gsl_vector_ushort_max (const gsl_vector_ushort * v);
GSL_EXPORT unsigned short gsl_vector_ushort_min (const gsl_vector_ushort * v);
GSL_EXPORT void gsl_vector_ushort_minmax (const gsl_vector_ushort * v, unsigned short * min_out, unsigned short * max_out);
