...
GSL_EXPORT gsl_vector_char *gsl_vector_char_alloc_from_block (gsl_block_char * b,
                                                                const size_t offset,
                                                                const size_t n,
                                                                const size_t stride);

GSL_EXPORT gsl_vector_char *gsl_vector_char_alloc_from_vector (gsl_vector_char * v,
                                                                 const size_t offset,
                                                                 const size_t n,
                                                                 const size_t stride);
...
GSL_EXPORT int gsl_vector_char_fprintf (FILE * stream, const gsl_vector_char * v,
                                         const char *format);
