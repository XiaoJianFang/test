...
GSL_EXPORT gsl_vector_float *gsl_vector_float_alloc_from_block (gsl_block_float * b,
                                                                const size_t offset,
                                                                const size_t n,
                                                                const size_t stride);

GSL_EXPORT gsl_vector_float *gsl_vector_float_alloc_from_vector (gsl_vector_float * v,
                                                                 const size_t offset,
                                                                 const size_t n,
                                                                 const size_t stride);
...
GSL_EXPORT int gsl_vector_float_fprintf (FILE * stream, const gsl_vector_float * v,
                                         const char *format);
