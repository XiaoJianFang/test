...
GSL_EXPORT int gsl_multiroot_fdjacobian (gsl_multiroot_function * F,
...
GSL_EXPORT int gsl_multiroot_fsolver_set (gsl_multiroot_fsolver * s,
...
GSL_EXPORT int gsl_multiroot_test_delta (const gsl_vector * dx, const gsl_vector * x,
